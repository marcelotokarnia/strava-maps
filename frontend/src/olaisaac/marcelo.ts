...
const marcelo: ParsedStravaProfile & { shortname: string } = {
  createdAt: '2015-11-21T00:38:38Z',
  id: '12209995',
  name: 'Marcelo Tokarnia',
  picture: 'https://dgalywyr863hv.cloudfront.net/pictures/athletes/12209995/3792689/1/large.jpg',
  shortname: 'Marcelo T.',
  username: 'mtokarnia',
}
...
export const marceloActivities: any = [
  {
    ...
    id: '4950174429',
    name: 'Cabelin na régua 💇‍♂️',
    pace: {
      average: 290,
    },
    polyline:
      'xolfDjmyfHwCiAe@K_Ck@]Ee@Ms@OoBY_@ZOAOi@Gi@EgDGwA?i@BU_@mDUsAOsAKmG@kCCg@CuCIiCCgCKyBGmKOqE@wACyAI{AQcGGk@aAkJOmBAk@WqASuAEm@Kk@[mDe@{Bs@kF{A}GOi@YyA]uAs@eE]qAYwAq@cCuCeJoA_D{@cC}@yBOg@}BwE_AuBsCgEsAcCyAwBu@aAaA}AsDoE]]o@_AY]s@{@eAcAoEsC_@W[]Mi@Hg@Nm@EtAHd@ZZrChB~ApAj@j@jDbE\\\\X\\zCfEh@z@vArBdAlBp@~@j@hArBlDl@hAj@lApAbD`AnBd@lAr@xBlAbDJd@t@pBl@tB`AxCl@~CPj@XrAx@pEh@xBVrA`AbEn@hDjAjKLhB\\pAFh@LtBV`C^`CFjAJf@JpAXnEF~B?z@NfK?xAFj@BlFNlE?`CHlD?l@LzF?lAFtADl@^~BBtADf@DTFACm@Kg@MuAQyAOkBAg@IgEAeEOkDK{EEuFK}DBaFCwABi@C]MJJtACvA@|AAl@@zALnD@l@Hf@HFK^?`AJvB@pDLpFL~B?rDRdDJh@PrALtALf@E~BFj@@fCBj@T^D@`@Wb@DtDr@b@L`Cd@l@RhAd@|Bp@',
    startDate: '2021-03-15T10:36:15Z',
    startPosition: {
      lat: -27.430526,
      lng: -48.46822,
    },
