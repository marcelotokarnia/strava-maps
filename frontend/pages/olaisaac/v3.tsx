...
import { fetchOlaIsaacV3 } from 'store/actions/thunks'
...
const Activities: FC<ActivitiesProps> = ({ defaultCenter, fetchedActivities, fetchOlaIsaacV3 }) => {
  useEffect(() => {
...
export default () => (
  <>
    <Head>
      ...
      <meta property="og:description" content="Isaackers correram bastante na semana 27.21 👏🏻" />
      <meta
        property="og:image"
