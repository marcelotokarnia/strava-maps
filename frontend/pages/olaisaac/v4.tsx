...
import { fetchOlaIsaacV4 } from 'store/actions/thunks'
...
const Activities: FC<ActivitiesProps> = ({ defaultCenter, fetchedActivities, fetchOlaIsaacV4 }) => {
  useEffect(() => {
...
export default () => (
  <>
    <Head>
      ...
      <meta property="og:description" content="Isaackers correram bastante na semana 41.21 👏🏻" />
      <meta
        property="og:image"
      ...
      />
      <meta property="og:url" content="https://strava.tokarnia.tech/olaisaac/v4" />
    </Head>
    <DYNOComponent />
  </>
)
